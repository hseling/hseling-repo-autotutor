...
## Development environment and release process
 ...
 - create virtualenv with Flask and Autotutor installed into it (latter is installed in
...
install it (`pip install hseling_api_autotutor.tar.gz`), ensure that configuration file exists and
`HSELING_API_AUTOTUTOR_SETTINGS` environment variable points to it, ensure that user has access to the
